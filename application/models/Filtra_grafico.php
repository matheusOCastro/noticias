...
$_POST['situacao'] = ( isset($_POST['situacao']) ) ? 'checked' : null;
$_POST['qualidade'] = ( isset($_POST['qualidade']) ) ? 'checked' : null;

if($_POST['situacao']==null && $_POST['qualidade']==null){
    $_POST['situacao']='checked';
}
if (!$_POST['qualidade']==null){
    $_POST['qualidade']='checked';
    $_POST['situacao']=null;
}
if (!$_POST['situacao']==null){
    $_POST['qualidade']=null;
    $_POST['situacao']='checked';
}

if ($_POST['situacao'] == 'checked'){
...
$array_grafico = implode("|", $arraySituacao);

}
if ($_POST['qualidade'] == 'checked'){
